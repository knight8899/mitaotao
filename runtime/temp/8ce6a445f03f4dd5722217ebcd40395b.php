<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"F:\maccms_v10_full\zishiying\pgcms/application/admin\view\system\config.html";i:1631263271;s:74:"F:\maccms_v10_full\zishiying\pgcms\application\admin\view\public\head.html";i:1631263271;s:74:"F:\maccms_v10_full\zishiying\pgcms\application\admin\view\public\foot.html";i:1631263271;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-form-item">
					...
					<fieldset class="layui-elem-field">
                        <legend>注册赠送VIP</legend>
                        <div class="layui-field-box">
                            <div class="layui-form-item">
                                <label class="layui-form-label">注册赠送天数：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_reg_vip]" placeholder="" value="<?php echo $config['site']['site_reg_vip']; ?>" class="layui-input w150" >
                                </div>
                            </div>
                        </div>
                    </fieldset>
					<fieldset class="layui-elem-field">
                        ...
                        <div class="layui-field-box">
                            <div class="layui-form-item">
                                <label class="layui-form-label">邀请：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_invitenum_0]" placeholder=""
                                           value="<?php echo $config['site']['site_invitenum_0']; ?>" class="layui-input w150">
                                </div>


                                <label class="layui-form-label">赠送：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_invitetime_0]" placeholder=""
                                           value="<?php echo $config['site']['site_invitetime_0']; ?>" class="layui-input w150">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">邀请：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_invitenum_1]" placeholder=""
                                           value="<?php echo $config['site']['site_invitenum_1']; ?>" class="layui-input w150">
                                </div>


                                <label class="layui-form-label">赠送：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_invitetime_1]" placeholder=""
                                           value="<?php echo $config['site']['site_invitetime_1']; ?>" class="layui-input w150">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">邀请：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_invitenum_2]" placeholder=""
                                           value="<?php echo $config['site']['site_invitenum_2']; ?>" class="layui-input w150">
                                </div>
                                <label class="layui-form-label">赠送：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_invitetime_2]" placeholder=""
                                           value="<?php echo $config['site']['site_invitetime_2']; ?>" class="layui-input w150">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">邀请：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_invitenum_3]" placeholder=""
                                           value="<?php echo $config['site']['site_invitenum_3']; ?>" class="layui-input w150">
                                </div>

                                <label class="layui-form-label">赠送：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_invitetime_3]" placeholder=""
                                           value="<?php echo $config['site']['site_invitetime_3']; ?>" class="layui-input w150">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">邀请：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_invitenum_4]" placeholder=""
                                           value="<?php echo $config['site']['site_invitenum_4']; ?>" class="layui-input w150">
                                </div>

                                <label class="layui-form-label">赠送：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_invitetime_4]" placeholder=""
                                           value="<?php echo $config['site']['site_invitetime_4']; ?>" class="layui-input w150">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">邀请：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_invitenum_5]" placeholder=""
                                           value="<?php echo $config['site']['site_invitenum_5']; ?>" class="layui-input w150">
                                </div>

                                <label class="layui-form-label">赠送：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_invitetime_5]" placeholder=""
                                           value="<?php echo $config['site']['site_invitetime_5']; ?>" class="layui-input w150">
                                </div>
                            </div>
                        </div>
                    </fieldset>
					<fieldset class="layui-elem-field">
                        ...
                        <div class="layui-field-box">
                            <div class="layui-form-item">
                                <label class="layui-form-label">体验会员：</label>
                                <label class="layui-form-label">所需金额：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_point_0]" placeholder=""
                                           value="<?php echo $config['site']['site_point_0']; ?>" class="layui-input w150">
                                </div>


                                <label class="layui-form-label">体验天数：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_time_0]" placeholder=""
                                           value="<?php echo $config['site']['site_time_0']; ?>" class="layui-input w150">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">VIP充值会员：</label>
                                <label class="layui-form-label">所需金额：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_point_1]" placeholder=""
                                           value="<?php echo $config['site']['site_point_1']; ?>" class="layui-input w150">
                                </div>


                                <label class="layui-form-label">升级天数：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_time_1]" placeholder=""
                                           value="<?php echo $config['site']['site_time_1']; ?>" class="layui-input w150">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="background: #fff;border: 0;"></label>
                                <label class="layui-form-label">所需金额：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_point_2]" placeholder=""
                                           value="<?php echo $config['site']['site_point_2']; ?>" class="layui-input w150">
                                </div>


                                <label class="layui-form-label">升级天数：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_time_2]" placeholder=""
                                           value="<?php echo $config['site']['site_time_2']; ?>" class="layui-input w150">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="background: #fff;border: 0;"></label>
                                <label class="layui-form-label">所需金额：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_point_3]" placeholder=""
                                           value="<?php echo $config['site']['site_point_3']; ?>" class="layui-input w150">
                                </div>
                                <label class="layui-form-label">升级天数：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="site[site_time_3]" placeholder=""
                                           value="<?php echo $config['site']['site_time_3']; ?>" class="layui-input w150">
                                </div>
                            </div>
                        </div>
                    </fieldset>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline w600">
                        <input type="radio" name="app[input_type]" value="0" title="<?php echo lang('get'); ?>" <?php if($config['app']['input_type'] != 1): ?>checked <?php endif; ?>>
                        <input type="radio" name="app[input_type]" value="1" title="<?php echo lang('get+post'); ?>" <?php if($config['app']['input_type'] == 1): ?>checked <?php endif; ?>>
                    </div>
